...
public class ColumnGrid : CustomGrid
{
    ...
    protected override Size MeasureOverride(Size availableSize)
    {
        ...
        if (double.IsInfinity(Height)) Height = 10;
...
public class RowGrid : CustomGrid
{
    ...
    public RowGrid AddChild(GridType GridType, double GridValue, UIElement Element)
    {
        SetGridType(Element, GridType);
        SetGridValue(Element, GridValue);
        Children.Add(Element);
    ...
    public RowGrid AddChild(GridType GridType, UIElement Element)
        => AddChild(GridType: GridType, GridValue: 1, Element: Element);
    public RowGrid AddChild(UIElement Element)
        => AddChild(GridType: GridType.Star, Element: Element);
}
...
public static class Extension
{
    ...
    public static Border SetChild<T>(this Border Value, UIElement Child)
    {
        Value.Child = Child;
        return Value;
    }
    public static T Assign<T>(this T Value, out T Varable)
    {
        Varable = Value;
        return Value;
    }
